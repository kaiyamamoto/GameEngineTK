...
namespace YamagenLib
{
	...
	private:
		// キーボード
		static std::unique_ptr<DirectX::Keyboard> m_keybord;

		// キーボードトラッカー
		static std::unique_ptr<DirectX::Keyboard::KeyboardStateTracker> m_keyTracker;
	...
	public:
		...
		// キーを押したフレームだけ true を返す
		static bool GetKeyDown(Key key);

		// キーを離したフレームだけ true を返す
